...
import { Address as Address7, HDKey, Secp256k1 as Secp256k12 } from "@vechain/sdk-core";
var ProviderInternalHDWallet = class extends ProviderInternalBaseWallet {
   ...
   */
  constructor(mnemonic, count = 1, initialIndex = 0, derivationPath = HDKey.VET_DERIVATION_PATH, options) {
    super(
...
import {
  JSONRPCInvalidParams as JSONRPCInvalidParams27,
...
import { JSONRPCInvalidParams as JSONRPCInvalidParams18 } from "@vechain/sdk-errors";
import { Hex as Hex10, Keccak256 as Keccak2564 } from "@vechain/sdk-core";
var web3Sha3 = async (params) => {
  if (params.length !== 1 || typeof params[0] !== "string" || !Hex10.isValid(params[0]))
  ...
  return await Promise.resolve(Keccak2564.of(params[0]).toString());
};

// src/provider/utils/rpc-mapper/methods-map/methods/eth_subscribe/eth_subscribe.ts
import { Hex as Hex11 } from "@vechain/sdk-core";
import {
...
var ethSubscribe = async (thorClient, params, provider) => {
  ...
  const subscriptionId = Hex11.random(16).digits;
...
import { VeChainSDKLogger as VeChainSDKLogger2 } from "@vechain/sdk-logging";
var ethFeeHistory = async () => {
  VeChainSDKLogger2("warning").log({
...
import { JSONRPCInvalidParams as JSONRPCInvalidParams22 } from "@vechain/sdk-errors";
import { ThorId as ThorId8 } from "@vechain/sdk-core";
var ethGetBlockTransactionCountByHash = async (thorClient, params) => {
  if (params.length !== 1 || typeof params[0] !== "string" || !ThorId8.isValid(params[0]))
...
import { JSONRPCInvalidParams as JSONRPCInvalidParams23 } from "@vechain/sdk-errors";
var ethGetBlockTransactionCountByNumber = async (thorClient, params) => {
  if (params.length !== 1 || typeof params[0] !== "string")
    throw new JSONRPCInvalidParams23(
...
import {
  ...
  JSONRPCInvalidParams as JSONRPCInvalidParams24,
...
var ethGetTransactionByBlockHashAndIndex = async (thorClient, params) => {
  if (params.length !== 2 || typeof params[0] !== "string" || typeof params[1] !== "string")
    throw new JSONRPCInvalidParams24(
...
import {
  JSONRPCInternalError as JSONRPCInternalError22,
  JSONRPCInvalidParams as JSONRPCInvalidParams25,
  stringifyData as stringifyData25
} from "@vechain/sdk-errors";
var ethGetTransactionByBlockNumberAndIndex = async (thorClient, params) => {
  if (params.length !== 2 || typeof params[0] !== "string" || typeof params[1] !== "string")
    throw new JSONRPCInvalidParams25(
      "eth_getTransactionByBlockHashAndIndex",
      -32602,
      `Invalid input params for "eth_getTransactionByBlockHashAndIndex" method. See ${RPC_DOCUMENTATION_URL} for details.`,
      { params }
  ...
  try {
    ...
    throw new JSONRPCInternalError22(
      "eth_getTransactionByBlockNumberAndIndex()",
      -32603,
      'Method "eth_getTransactionByBlockNumberAndIndex" failed.',
      {
        params: stringifyData25(params),
        url: thorClient.httpClient.baseURL,
        innerError: stringifyData25(e)
      }
    );
  }
};
...
import { VeChainSDKLogger as VeChainSDKLogger3 } from "@vechain/sdk-logging";
var ethGetUncleByBlockHashAndIndex = async () => {
  VeChainSDKLogger3("warning").log({
...
import { VeChainSDKLogger as VeChainSDKLogger4 } from "@vechain/sdk-logging";
var ethGetUncleByBlockNumberAndIndex = async () => {
  VeChainSDKLogger4("warning").log({
...
import { VeChainSDKLogger as VeChainSDKLogger5 } from "@vechain/sdk-logging";
var ethGetUncleCountByBlockHash = async () => {
  VeChainSDKLogger5("warning").log({
...
import { VeChainSDKLogger as VeChainSDKLogger6 } from "@vechain/sdk-logging";
var ethGetUncleCountByBlockNumber = async () => {
  VeChainSDKLogger6("warning").log({
...
import { VeChainSDKLogger as VeChainSDKLogger7 } from "@vechain/sdk-logging";
var ethGetWork = async () => {
  VeChainSDKLogger7("warning").log({
    title: "eth_getWork",
...
import { VeChainSDKLogger as VeChainSDKLogger8 } from "@vechain/sdk-logging";
var ethMining = async () => {
  VeChainSDKLogger8("warning").log({
    title: "eth_mining",
...
import { VeChainSDKLogger as VeChainSDKLogger9 } from "@vechain/sdk-logging";
var ethHashrate = async () => {
  VeChainSDKLogger9("warning").log({
    title: "eth_hashrate",
...
import { VeChainSDKLogger as VeChainSDKLogger10 } from "@vechain/sdk-logging";
var ethProtocolVersion = async () => {
  VeChainSDKLogger10("warning").log({
...
import { VeChainSDKLogger as VeChainSDKLogger11 } from "@vechain/sdk-logging";
var ethSign = async () => {
  VeChainSDKLogger11("warning").log({
    title: "eth_sign",
...
import { VeChainSDKLogger as VeChainSDKLogger12 } from "@vechain/sdk-logging";
var ethSubmitWork = async () => {
  VeChainSDKLogger12("warning").log({
...
import { JSONRPCInternalError as JSONRPCInternalError23, stringifyData as stringifyData26 } from "@vechain/sdk-errors";
var netListening = async (thorClient) => {
  try {
    return await thorClient.nodes.isHealthy();
  } catch (e) {
    throw new JSONRPCInternalError23(
      "net_listening",
      -32603,
      'Method "net_listening" failed.',
      {
        url: thorClient.httpClient.baseURL,
        innerError: stringifyData26(e)
      }
    );
  }
};
...
import { JSONRPCInternalError as JSONRPCInternalError24, stringifyData as stringifyData27 } from "@vechain/sdk-errors";
var netPeerCount = async (thorClient) => {
  try {
    const peers = await thorClient.nodes.getNodes();
    return peers !== null ? peers.length : 0;
  } catch (e) {
    throw new JSONRPCInternalError24(
      "net_peerCount",
      -32603,
      'Method "net_peerCount" failed.',
      {
        url: thorClient.httpClient.baseURL,
        innerError: stringifyData27(e)
      }
    );
  }
};
...
import { VeChainSDKLogger as VeChainSDKLogger13 } from "@vechain/sdk-logging";
var parityNextNonce = async () => {
  VeChainSDKLogger13("warning").log({
...
import { VeChainSDKLogger as VeChainSDKLogger14 } from "@vechain/sdk-logging";
var ethNewFilter = async () => {
  VeChainSDKLogger14("warning").log({
    title: "eth_newFilter",
...
import { VeChainSDKLogger as VeChainSDKLogger15 } from "@vechain/sdk-logging";
var ethNewBlockFilter = async () => {
  VeChainSDKLogger15("warning").log({
...
import { VeChainSDKLogger as VeChainSDKLogger16 } from "@vechain/sdk-logging";
var ethNewPendingTransactionFilter = async () => {
  VeChainSDKLogger16("warning").log({
...
import { VeChainSDKLogger as VeChainSDKLogger17 } from "@vechain/sdk-logging";
var ethGetFilterLogs = async () => {
  VeChainSDKLogger17("warning").log({
...
import { VeChainSDKLogger as VeChainSDKLogger18 } from "@vechain/sdk-logging";
var ethGetFilterChanges = async () => {
  VeChainSDKLogger18("warning").log({
...
import { VeChainSDKLogger as VeChainSDKLogger19 } from "@vechain/sdk-logging";
var ethUninstallFilter = async () => {
  VeChainSDKLogger19("warning").log({
...
import { VeChainSDKLogger as VeChainSDKLogger20 } from "@vechain/sdk-logging";
var debugGetBadBlocks = async () => {
  VeChainSDKLogger20("warning").log({
...
import { VeChainSDKLogger as VeChainSDKLogger21 } from "@vechain/sdk-logging";
var debugGetRawBlock = async () => {
  VeChainSDKLogger21("warning").log({
...
import { VeChainSDKLogger as VeChainSDKLogger22 } from "@vechain/sdk-logging";
var debugGetRawHeader = async () => {
  VeChainSDKLogger22("warning").log({
...
import { VeChainSDKLogger as VeChainSDKLogger23 } from "@vechain/sdk-logging";
var debugGetRawReceipts = async () => {
  VeChainSDKLogger23("warning").log({
...
import { VeChainSDKLogger as VeChainSDKLogger24 } from "@vechain/sdk-logging";
var debugGetRawTransaction = async () => {
  VeChainSDKLogger24("warning").log({
...
import { VeChainSDKLogger as VeChainSDKLogger25 } from "@vechain/sdk-logging";
var engineExchangeCapabilities = async () => {
  VeChainSDKLogger25("warning").log({
...
import { VeChainSDKLogger as VeChainSDKLogger26 } from "@vechain/sdk-logging";
var engineExchangeTransitionConfigurationV1 = async () => {
  VeChainSDKLogger26("warning").log({
...
import { VeChainSDKLogger as VeChainSDKLogger27 } from "@vechain/sdk-logging";
var engineForkchoiceUpdatedV1 = async () => {
  VeChainSDKLogger27("warning").log({
...
import { VeChainSDKLogger as VeChainSDKLogger28 } from "@vechain/sdk-logging";
var engineForkchoiceUpdatedV2 = async () => {
  VeChainSDKLogger28("warning").log({
...
import { VeChainSDKLogger as VeChainSDKLogger29 } from "@vechain/sdk-logging";
var engineForkchoiceUpdatedV3 = async () => {
  VeChainSDKLogger29("warning").log({
...
import { VeChainSDKLogger as VeChainSDKLogger30 } from "@vechain/sdk-logging";
var engineGetPayloadBodiesByHashV1 = async () => {
  VeChainSDKLogger30("warning").log({
...
import { VeChainSDKLogger as VeChainSDKLogger31 } from "@vechain/sdk-logging";
var engineGetPayloadBodiesByRangeV1 = async () => {
  VeChainSDKLogger31("warning").log({
...
import { VeChainSDKLogger as VeChainSDKLogger32 } from "@vechain/sdk-logging";
var engineGetPayloadV1 = async () => {
  VeChainSDKLogger32("warning").log({
...
import { VeChainSDKLogger as VeChainSDKLogger33 } from "@vechain/sdk-logging";
var engineGetPayloadV2 = async () => {
  VeChainSDKLogger33("warning").log({
...
import { VeChainSDKLogger as VeChainSDKLogger34 } from "@vechain/sdk-logging";
var engineGetPayloadV3 = async () => {
  VeChainSDKLogger34("warning").log({
...
import { VeChainSDKLogger as VeChainSDKLogger35 } from "@vechain/sdk-logging";
var engineNewPayloadV1 = async () => {
  VeChainSDKLogger35("warning").log({
...
import { VeChainSDKLogger as VeChainSDKLogger36 } from "@vechain/sdk-logging";
var engineNewPayloadV2 = async () => {
  VeChainSDKLogger36("warning").log({
...
import { VeChainSDKLogger as VeChainSDKLogger37 } from "@vechain/sdk-logging";
var engineNewPayloadV3 = async () => {
  VeChainSDKLogger37("warning").log({
...
import { VeChainSDKLogger as VeChainSDKLogger38 } from "@vechain/sdk-logging";
var ethCreateAccessList = async () => {
  VeChainSDKLogger38("warning").log({
...
import {
  JSONRPCInternalError as JSONRPCInternalError25,
  JSONRPCInvalidParams as JSONRPCInvalidParams26,
  stringifyData as stringifyData28
} from "@vechain/sdk-errors";
var ethGetBlockReceipts = async (thorClient, params) => {
  if (params.length !== 1 || typeof params[0] !== "string")
    throw new JSONRPCInvalidParams26(
  ...
  try {
    ...
    throw new JSONRPCInternalError25(
      "ethGetBlockReceipts()",
      -32603,
      'Method "ethGetBlockReceipts" failed.',
      {
        params: stringifyData28(params),
        url: thorClient.httpClient.baseURL,
        innerError: stringifyData28(e)
      }
    );
  }
};
...
import { VeChainSDKLogger as VeChainSDKLogger39 } from "@vechain/sdk-logging";
var ethGetProof = async () => {
  VeChainSDKLogger39("warning").log({
    title: "eth_getProof",
...
import { VeChainSDKLogger as VeChainSDKLogger40 } from "@vechain/sdk-logging";
var ethMaxPriorityFeePerGas = async () => {
  VeChainSDKLogger40("warning").log({
...
import { VeChainSDKLogger as VeChainSDKLogger41 } from "@vechain/sdk-logging";
var ethSignTransaction = async () => {
  VeChainSDKLogger41("warning").log({
...
var VeChainProvider = class extends EventEmitter2 {
  ...
  constructor(thorClient, wallet, enableDelegation = false) {
    ...
    if (enableDelegation && wallet?.delegator === void 0) {
      throw new JSONRPCInvalidParams27(
...
import {
  JSONRPCInternalError as JSONRPCInternalError26,
  stringifyData as stringifyData29,
  VechainSDKError
} from "@vechain/sdk-errors";
import { VeChainSDKLogger as VeChainSDKLogger42 } from "@vechain/sdk-logging";
  ...
  async request(args) {
    try {
      if (this.debug) {
        ...
        VeChainSDKLogger42("log").log({
          title: `Sending request - ${args.method}`,
          messages: [
            `params: ${stringifyData29(args.params)}`,
            `accounts: ${stringifyData29(accounts)}`,
            `delegator: ${stringifyData29(delegator)}`,
      ...
      if (this.debug) {
        VeChainSDKLogger42("log").log({
          ...
          messages: [`result: ${stringifyData29(result)}`]
        });
      }
      return result;
    } catch (error) {
      if (this.debug) {
        VeChainSDKLogger42("error").log(
          new JSONRPCInternalError26(
            args.method,
            -32603,
