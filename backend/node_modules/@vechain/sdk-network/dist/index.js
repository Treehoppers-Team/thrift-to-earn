...
var PARAMS_ABI = (0, import_sdk_errors.stringifyData)([
  {
    constant: false,
    inputs: [
      {
...
var ENERGY_ABI = (0, import_sdk_errors.stringifyData)([
  {
    constant: true,
    inputs: [],
    name: "name",
...
var ERROR_SELECTOR = import_sdk_core.Keccak256.of(import_sdk_core.Txt.of("Error(string)").bytes).toString().slice(0, 10);
var PANIC_SELECTOR = import_sdk_core.Keccak256.of(import_sdk_core.Txt.of("Panic(uint256)").bytes).toString().slice(0, 10);
...
var HttpClient = class {
  ...
  async http(method, path, params) {
    ...
    try {
      ...
      throw new import_sdk_errors2.InvalidHTTPRequest(
        "HttpClient.http()",
    ...
    try {
      ...
      if (error instanceof import_sdk_errors2.InvalidHTTPRequest) {
        throw error;
      }
      throw new import_sdk_errors2.InvalidHTTPRequest(
        "HttpClient.http()",
...
function SyncPoll(pollingFunction, options) {
  if (options?.requestIntervalInMilliseconds !== void 0 && (options.requestIntervalInMilliseconds <= 0 || !Number.isInteger(options.requestIntervalInMilliseconds))) {
    throw new import_sdk_errors3.InvalidDataType(
      "SyncPoll()",
  ...
  return {
    ...
    waitUntil: async (condition) => {
      try {
        ...
        throw new import_sdk_errors3.PollExecution(
          "SyncPoll.waitUntil()",
...
var EventPoll = class extends import_events.EventEmitter {
  ...
  constructor(pollingFunction, requestIntervalInMilliseconds, hasToStopOnError) {
    ...
    if (requestIntervalInMilliseconds !== void 0 && (requestIntervalInMilliseconds <= 0 || !Number.isInteger(requestIntervalInMilliseconds))) {
      throw new import_sdk_errors4.InvalidDataType(
        "SyncPoll()",
        'Polling failed: Invalid input for field "options?.maximumWaitingTimeInMilliseconds" it must be a positive number',
        {
          requestIntervalInMilliseconds
  ...
  async _intervalLoop() {
    try {
      ...
      this.error = new import_sdk_errors4.PollExecution(
...
var getEventSubscriptionUrl = (baseURL, event, indexedValues, options) => {
  if (import_sdk_core2.vechain_sdk_core_ethers.EventFragment.isFragment(event)) {
    event = event.format("full");
  }
  const ev = new import_sdk_core2.abi.Event(event);
...
var resolveNames = async (thorClient, names) => {
  ...
  if (genesisBlock === null || !import_sdk_core4.Address.isValid(NetworkContracts[genesisBlock.id]?.resolveUtils)) {
  ...
  return addresses.map((address) => {
    if (address === import_sdk_core4.ZERO_ADDRESS || !import_sdk_core4.Address.isValid(address)) {
      return null;
    }
    return address;
  });
...
var AccountsModule = class {
  ...
  async getAccount(address, options) {
    if (!import_sdk_core5.Address.isValid(address)) {
    ...
    if (options?.revision !== null && options?.revision !== void 0 && !import_sdk_core5.Revision.isValid(options.revision)) {
      throw new import_sdk_errors6.InvalidDataType(
        "AccountsModule.getAccount()",
  ...
  async getStorageAt(address, position, options) {
    ...
    if (!import_sdk_core5.ThorId.isValid(position)) {
      throw new import_sdk_errors6.InvalidDataType(
        "AccountsModule.getStorageAt()",
...
var BlocksModule = class {
  ...
  async getBlockCompressed(revision) {
    if (revision !== null && revision !== void 0 && !import_sdk_core6.Revision.isValid(revision)) {
    ...
    get: (_target, prop) => {
      return async (...args) => {
        if (contract.getSigner() === void 0) {
          throw new import_sdk_errors8.InvalidTransactionField(
            "getTransactProxy()",
  ...
  return new Proxy(contract.clause, {
    get: (_target, prop) => {
      return (...args) => {
        ...
        args = extractAdditionalOptionsResult.args;
        return {
          clause: import_sdk_core7.clauseBuilder.functionInteraction(
            contract.address,
            contract.getFunctionFragment(prop),
            args,
...
function buildCriteria(contract, prop, args) {
  const eventFragment = new import_sdk_core7.fragment.Event(contract.getEventFragment(prop));
...
var Contract = class {
  ...
  getFunctionFragment(prop) {
    ...
    if (functionFragment == null) {
      throw new import_sdk_errors9.InvalidAbiFragment(
...
var ContractFactory = class {
  ...
  async startDeployment(deployParams, options) {
    ...
    this.deployTransaction = await this.thor.transactions.sendTransaction(
      import_sdk_core9.TransactionHandler.decode(
  ...
  async waitForDeployment() {
    if (this.deployTransaction?.id === void 0) {
      throw new import_sdk_errors10.CannotFindTransaction(
    ...
    if (transactionReceipt?.outputs[0]?.contractAddress === null || transactionReceipt?.outputs[0]?.contractAddress === void 0) {
      throw new import_sdk_errors10.ContractDeploymentFailed(
        "ContractFactory.waitForDeployment()",
...
var SOLIDITY_ERROR_SELECTOR = import_sdk_core10.Keccak256.of(import_sdk_core10.Txt.of("Error(string)").bytes).toString().slice(0, 10);
var SOLIDITY_PANIC_SELECTOR = import_sdk_core10.Keccak256.of(import_sdk_core10.Txt.of("Panic(uint256)").bytes).toString().slice(0, 10);

// src/thor-client/gas/helpers/decode-evm-error.ts
function decodeRevertReason(data) {
  if (data.startsWith(SOLIDITY_ERROR_SELECTOR))
    return import_sdk_core11.abi.decode(
      "string",
      "0x" + data.slice(SOLIDITY_ERROR_SELECTOR.length)
    );
  if (data.startsWith(SOLIDITY_PANIC_SELECTOR)) {
    const decoded = import_sdk_core11.abi.decode(
      "uint256",
...
var ContractsModule = class {
  ...
  async executeCall(contractAddress, functionFragment, functionData, contractCallOptions) {
      ...
      [
        {
          to: contractAddress,
          value: "0",
          data: new import_sdk_core12.abi.Function(functionFragment).encodeInput(
            functionData
          )
        }
      ],
    ...
    if (response[0].reverted) {
      ...
      return new import_sdk_core12.abi.Function(functionFragment).decodeOutput(
        response[0].data
      );
    }
  }
  ...
  async executeMultipleClausesCall(clauses, options) {
    ...
    return response.map((res, index) => {
      return new import_sdk_core12.abi.Function(
  ...
  async executeTransaction(signer, contractAddress, functionFragment, functionData, options) {
    const id = await signer.sendTransaction({
      clauses: [
        ...
        import_sdk_core12.clauseBuilder.functionInteraction(
          contractAddress,
          functionFragment,
          functionData,
          options?.value ?? 0
  ...
  async getBaseGasPrice() {
    return await this.executeCall(
      ...
      import_sdk_core12.coder.createInterface(BUILT_IN_CONTRACTS.PARAMS_ABI).getFunction("get"),
      [import_sdk_core12.dataUtils.encodeBytes32String("base-gas-price", "left")]
    );
  }
};
...
var DebugModule = class {
  ...
  async traceContractCall(input, name) {
    if (input.contractInput?.to !== void 0 && input.contractInput.to !== null && !import_sdk_core13.Address.isValid(input.contractInput.to)) {
    ...
    if (input.contractInput?.data !== void 0 && !import_sdk_core13.Hex.isValid(input.contractInput.data))
      throw new import_sdk_errors11.InvalidDataType(
        "DebugModule.traceContractCall()",
        `Invalid data '${input.contractInput?.data}' given as input for traceContractCall.`,
        { data: input.contractInput?.data }
      );
    if (input.contractInput?.value !== void 0 && !import_sdk_core13.Hex.isValid0x(input.contractInput.value)) {
      throw new import_sdk_errors11.InvalidDataType(
        "DebugModule.traceContractCall()",
  ...
  validateTarget(target, functionName) {
    if (!import_sdk_core13.ThorId.isValid(target.blockID)) {
      throw new import_sdk_errors11.InvalidDataType(
    ...
    if (typeof target.transaction === "string") {
      if (!import_sdk_core13.ThorId.isValid(target.transaction))
        throw new import_sdk_errors11.InvalidDataType(
          "DebugModule.validateTarget()",
...
var GasModule = class {
  ...
  async estimateGas(clauses, caller, options) {
    ...
    const intrinsicGas = import_sdk_core14.TransactionUtils.intrinsicGas(clauses);
  ...
  async filterEventLogs(filterOptions) {
    ...
    if (fragments !== void 0) {
      ...
      eventLogs.forEach((log) => {
        const eventFragment = new import_sdk_core15.abi.Event(
...
var TransactionsModule = class {
  ...
  async getTransaction(id, options) {
    if (!import_sdk_core16.ThorId.isValid(id)) {
    ...
    if (options?.head !== void 0 && !import_sdk_core16.ThorId.isValid(options.head))
      throw new import_sdk_errors14.InvalidDataType(
        "TransactionsModule.getTransaction()",
  ...
  async sendRawTransaction(raw) {
    if (!import_sdk_core16.Hex.isValid0x(raw)) {
      throw new import_sdk_errors14.InvalidDataType(
    ...
    try {
      import_sdk_core16.TransactionHandler.decode(Buffer.from(raw.slice(2), "hex"), true);
    } catch (error) {
      throw new import_sdk_errors14.InvalidDataType(
        "TransactionsModule.sendRawTransaction()",
  ...
  async sendTransaction(signedTx) {
    ...
    const rawTx = import_sdk_core16.Hex.of(signedTx.encoded).toString();
  ...
  async waitForTransaction(txID, options) {
    if (!import_sdk_core16.ThorId.isValid(txID)) {
      throw new import_sdk_errors14.InvalidDataType(
  ...
  async buildTransactionBody(clauses, gas, options) {
    ...
    if (genesisBlock === null)
      throw new import_sdk_errors14.InvalidTransactionField(
    ...
    return {
      ...
      nonce: options?.nonce ?? import_sdk_core16.Hex.random(8).toString(),
  ...
  async simulateTransaction(clauses, options) {
    ...
    if (revision !== void 0 && revision !== null && !import_sdk_core16.Revision.isValid(revision)) {
      throw new import_sdk_errors14.InvalidDataType(
  ...
  decodeRevertReason(encodedRevertReason, errorFragment) {
    if (encodedRevertReason.startsWith(ERROR_SELECTOR))
      ...
      if (errorFragment !== void 0) {
        const errorInterface = new import_sdk_core16.vechain_sdk_core_ethers.Interface([
          import_sdk_core16.vechain_sdk_core_ethers.ErrorFragment.from(errorFragment)
        ]);
        return errorInterface.decodeErrorResult(
          import_sdk_core16.vechain_sdk_core_ethers.ErrorFragment.from(
            errorFragment
          ),
          encodedRevertReason
        ).toArray()[0];
...
var _getDelegationSignature = async (tx, delegatorUrl, originAddress, httpClient) => {
  const rawTx = import_sdk_core17.Hex.of(tx.encoded).toString();
  ...
  try {
    ...
    throw new import_sdk_errors15.NotDelegatedTransaction(
...
var VeChainAbstractSigner = class {
  ...
  async populateCall(transactionToPopulate) {
    if (transactionToPopulate.from === void 0 || transactionToPopulate.from === null)
      transactionToPopulate.from = import_sdk_core18.Address.checksum(
        import_sdk_core18.HexUInt.of(await this.getAddress())
      );
    else {
      if (import_sdk_core18.Address.checksum(import_sdk_core18.HexUInt.of(transactionToPopulate.from)) !== import_sdk_core18.Address.checksum(import_sdk_core18.HexUInt.of(await this.getAddress()))) {
        throw new import_sdk_errors16.InvalidDataType(
          ...
          {
            signerAddress: import_sdk_core18.Address.checksum(
              import_sdk_core18.HexUInt.of(await this.getAddress())
            ),
            fromAddress: import_sdk_core18.Address.checksum(
              import_sdk_core18.HexUInt.of(transactionToPopulate.from)
            )
          }
        );
      }
  ...
  async populateTransaction(transactionToPopulate) {
    if (this.provider === null) {
      throw new import_sdk_errors16.JSONRPCInvalidParams(
  ...
  async getNonce(blockTag) {
    ...
    return import_sdk_core18.Hex.random(6).toString();
  }
  /**
  ...
  _buildClauses(transaction) {
    return transaction.to !== void 0 && transaction.to !== null ? (
      ...
      [import_sdk_core18.clauseBuilder.deployContract(transaction.data ?? "0x")]
    );
  }
};
...
var VeChainPrivateKeySigner = class _VeChainPrivateKeySigner extends VeChainAbstractSigner {
  ...
  constructor(privateKey, provider) {
    if (!import_sdk_core19.Secp256k1.isValidPrivateKey(privateKey)) {
      throw new import_sdk_errors17.InvalidSecp256k1PrivateKey(
  ...
  MESSAGE_PREFIX = import_sdk_core19.Txt.of("Ethereum Signed Message:\n").bytes;
  /**
   ...
   */
  async getAddress() {
    return import_sdk_core19.Address.checksum(
      import_sdk_core19.HexUInt.of(
        await Promise.resolve(
          import_sdk_core19.Address.ofPrivateKey(this.privateKey).toString()
        )
      )
    );
  }
  ...
  async signTransaction(transactionToSign) {
    if (this.provider === null) {
      throw new import_sdk_errors17.JSONRPCInvalidParams(
  ...
  async signMessage(message) {
    return await new Promise((resolve, reject) => {
      try {
        const body = typeof message === "string" ? import_sdk_core19.Txt.of(message).bytes : message;
        const sign = import_sdk_core19.Secp256k1.sign(
          import_sdk_core19.Keccak256.of(
            n_utils.concatBytes(
              this.MESSAGE_PREFIX,
              import_sdk_core19.Txt.of(body.length).bytes,
              body
            )
          ).bytes,
        ...
        resolve(import_sdk_core19.Hex.of(sign).toString());
      } catch (e) {
        reject(e);
      }
    });
  ...
  async signTypedData(domain, types, value) {
    return await new Promise((resolve, reject) => {
      try {
        const hash = import_sdk_core19.Hex.of(
          import_sdk_core19.vechain_sdk_core_ethers.TypedDataEncoder.hash(
            domain,
            types,
            value
          )
  ...
  async _signFlow(transaction, delegator, thorClient) {
    ...
    return delegator !== null ? await this._signWithDelegator(
      ...
      thorClient,
      delegator
    ) : import_sdk_core19.Hex.of(
      import_sdk_core19.TransactionHandler.sign(populatedTransaction, this.privateKey).encoded
    ).toString();
  }
  /**
  ...
  async _signWithDelegator(unsignedTransactionBody, originPrivateKey, thorClient, delegatorOptions) {
    const originAddress = import_sdk_core19.Address.ofPrivateKey(originPrivateKey).toString();
    const unsignedTx = new import_sdk_core19.Transaction(unsignedTransactionBody);
    if (delegatorOptions?.delegatorPrivateKey !== void 0)
      return import_sdk_core19.Hex.of(
        import_sdk_core19.TransactionHandler.signWithDelegator(
    ...
    const originSignature = import_sdk_core19.Secp256k1.sign(
      unsignedTx.getSignatureHash(),
      originPrivateKey
    );
    const signature = Buffer.concat([originSignature, delegatorSignature]);
    return import_sdk_core19.Hex.of(
      new import_sdk_core19.Transaction(unsignedTx.body, signature).encoded
    ).toString();
  }
};
...
var AbstractProviderInternalWallet = class {
  ...
  getAccountSync(addressOrIndex) {
    ...
    if (!import_sdk_core20.Address.isValid(addressOrIndex)) {
    ...
    const account = this.accounts.find(
      (account2) => import_sdk_core20.Address.checksum(import_sdk_core20.HexUInt.of(account2.address)) === import_sdk_core20.Address.checksum(import_sdk_core20.HexUInt.of(addressOrIndex))
    );
    return account ?? null;
  }
  /**
...
var ProviderInternalHDWallet = class extends ProviderInternalBaseWallet {
   ...
   */
  constructor(mnemonic, count = 1, initialIndex = 0, derivationPath = import_sdk_core21.HDKey.VET_DERIVATION_PATH, options) {
    super(
      [...Array(count).keys()].map((path) => {
        const privateKeyBuffer = import_sdk_core21.HDKey.fromMnemonic(
          mnemonic,
          derivationPath
        ...
        return {
          ...
          publicKey: Buffer.from(
            import_sdk_core21.Secp256k1.derivePublicKey(privateKeyBuffer)
          ),
          address: import_sdk_core21.Address.ofPrivateKey(privateKeyBuffer).toString()
        };
      }),
      options
    );
...
var JSONRPCEthersProvider = class extends import_sdk_core22.vechain_sdk_core_ethers.JsonRpcApiProvider {
  /**
    ...
    for (const jsonRpcPayload of requestPayloadArray) {
      try {
        ...
        responses.push({
          ...
          error: {
            code: -32603,
            message: (0, import_sdk_errors19.stringifyData)(e)
          }
        });
      }
    }
...
var RPC_METHODS = /* @__PURE__ */ ((RPC_METHODS2) => {
  ...
  RPC_METHODS2["web3_sha3"] = "web3_sha3";
...
var getCorrectBlockNumberRPCToVeChain = (block) => {
  if (typeof block === "string") {
    if (block === "latest" || block === "finalized" || block === "safe" || block === "pending")
      return "best";
    if (block === "earliest") return import_sdk_core23.Hex.of(0).toString();
    return block;
  }
  if (block.blockNumber !== void 0) {
    return import_sdk_core23.Hex.of(block.blockNumber).toString();
  }
...
var _formatTransactionToRPC = (tx, blockHash, blockNumber, chainId, txIndex) => {
  return {
    // Supported fields
    blockHash,
    blockNumber: import_sdk_core24.Quantity.of(blockNumber).toString(),
    from: tx.origin,
    gas: import_sdk_core24.Quantity.of(import_sdk_core24.HexUInt.of(tx.gas).bi).toString(),
    chainId,
    hash: tx.id,
    nonce: tx.nonce,
    transactionIndex: import_sdk_core24.Quantity.of(txIndex).toString(),
    /**
    ...
    value: tx.clauses[0]?.value !== void 0 ? import_sdk_core24.Quantity.of(import_sdk_core24.HexUInt.of(tx.clauses[0].value).bi).toString() : "",
    // Unsupported fields
    gasPrice: "0x0",
    type: "0x0",
    v: "0x0",
...
function formatTransactionReceiptToRPCStandard(transactionHash, receipt, transaction, blockContainsTransaction, chainId) {
  ...
  receipt.outputs.forEach((output) => {
    output.events.forEach((event) => {
      logs.push({
        ...
        blockNumber: import_sdk_core24.Quantity.of(receipt.meta.blockNumber).toString(),
        transactionHash: receipt.meta.txID,
        address: event.address,
        topics: event.topics.map((topic) => topic),
        data: event.data,
        removed: false,
        transactionIndex: import_sdk_core24.Quantity.of(transactionIndex).toString(),
        logIndex: import_sdk_core24.Quantity.of(logIndex).toString()
      });
      logIndex++;
    });
  });
  return {
    ...
    gasUsed: import_sdk_core24.Quantity.of(receipt.gasUsed).toString(),
    logs,
    ...
    transactionIndex: import_sdk_core24.Quantity.of(transactionIndex).toString(),
    // Incompatible fields
    logsBloom: import_sdk_core24.Hex.of((0, import_sdk_core24.ZERO_BYTES)(256)).toString(),
...
var formatToRPCStandard2 = (block, chainId) => {
  ...
  return {
    ...
    number: import_sdk_core25.Quantity.of(block.number).toString(),
    size: import_sdk_core25.Quantity.of(block.size).toString(),
    stateRoot: block.stateRoot,
    receiptsRoot: block.receiptsRoot,
    transactionsRoot: block.txsRoot,
    timestamp: import_sdk_core25.Quantity.of(block.timestamp).toString(),
    gasLimit: import_sdk_core25.Quantity.of(block.gasLimit).toString(),
    gasUsed: import_sdk_core25.Quantity.of(block.gasUsed).toString(),
    transactions,
    ...
    totalDifficulty: "0x0",
    uncles: [],
    sha3Uncles: import_sdk_core25.HexUInt.of((0, import_sdk_core25.ZERO_BYTES)(32)).toString(),
    nonce: import_sdk_core25.HexUInt.of((0, import_sdk_core25.ZERO_BYTES)(8)).toString(),
    logsBloom: import_sdk_core25.HexUInt.of((0, import_sdk_core25.ZERO_BYTES)(256)).toString(),
    extraData: "0x",
    baseFeePerGas: "0x0",
    mixHash: import_sdk_core25.HexUInt.of((0, import_sdk_core25.ZERO_BYTES)(32)).toString()
  };
};
...
var formatToLogsRPC = (eventLogs) => {
  return eventLogs.map((eventLog) => {
    return {
      ...
      blockNumber: import_sdk_core26.HexInt.of(eventLog.meta.blockNumber).toString(),
      data: eventLog.data,
      logIndex: "0x0",
...
var ethBlockNumber = async (thorClient) => {
  try {
    ...
    throw new import_sdk_errors21.JSONRPCInternalError(
      "eth_blockNumber()",
      -32603,
      'Method "eth_blockNumber" failed.',
      {
        url: thorClient.httpClient.baseURL,
        innerError: (0, import_sdk_errors21.stringifyData)(e)
      }
    );
  }
};
...
var ethChainId = async (thorClient) => {
  try {
    ...
    if (genesisBlock?.id === null || genesisBlock?.id === void 0) {
      throw new import_sdk_errors22.JSONRPCInvalidParams(
        "eth_chainId()",
        -32602,
    ...
    if (genesisBlock.id === import_sdk_core27.networkInfo.mainnet.genesisBlock.id)
      return CHAIN_ID.MAINNET;
    return CHAIN_ID.TESTNET;
  } catch (e) {
    throw new import_sdk_errors22.JSONRPCInternalError(
      "eth_chainId()",
      -32603,
      'Method "eth_chainId" failed.',
      {
        url: thorClient.httpClient.baseURL,
        innerError: (0, import_sdk_errors22.stringifyData)(e)
      }
    );
  }
};
...
var ethGetBalance = async (thorClient, params) => {
  if (params.length !== 2 || typeof params[0] !== "string" || typeof params[1] !== "object" && typeof params[1] !== "string")
    throw new import_sdk_errors23.JSONRPCInvalidParams(
      "eth_getBalance",
      -32602,
  ...
  try {
    ...
    throw new import_sdk_errors23.JSONRPCInternalError(
      "eth_getBalance()",
      -32603,
      'Method "eth_getBalance" failed.',
      {
        params: (0, import_sdk_errors23.stringifyData)(params),
        url: thorClient.httpClient.baseURL,
...
var ethGetCode = async (thorClient, params) => {
  if (params.length !== 2 || typeof params[0] !== "string" || typeof params[1] !== "object" && typeof params[1] !== "string")
    throw new import_sdk_errors24.JSONRPCInvalidParams(
      "eth_getCode",
      -32602,
  ...
  try {
    ...
    throw new import_sdk_errors24.JSONRPCInternalError(
      "eth_getCode()",
      -32603,
      'Method "eth_getCode" failed.',
      {
        params: (0, import_sdk_errors24.stringifyData)(params),
        url: thorClient.httpClient.baseURL,
...
var ethGetStorageAt = async (thorClient, params) => {
  if (params.length !== 3 || typeof params[0] !== "string" || typeof params[1] !== "string" || typeof params[2] !== "object" && typeof params[2] !== "string")
    throw new import_sdk_errors25.JSONRPCInvalidParams(
      "eth_getStorageAt",
      -32602,
  ...
  try {
    ...
    return await thorClient.accounts.getStorageAt(
      address,
      import_sdk_core28.ThorId.of(storagePosition).toString(),
      {
        revision: getCorrectBlockNumberRPCToVeChain(block)
      }
    );
  } catch (e) {
    throw new import_sdk_errors25.JSONRPCInternalError(
      "eth_getStorageAt()",
      -32603,
...
var ethEstimateGas = async (thorClient, params) => {
  if (![1, 2].includes(params.length) || typeof params[0] !== "object")
    throw new import_sdk_errors26.JSONRPCInvalidParams(
      "eth_estimateGas",
      -32602,
  ...
  try {
    ...
    throw new import_sdk_errors26.JSONRPCInternalError(
      "eth_estimateGas()",
      -32603,
...
var ethCall = async (thorClient, params) => {
  if (params.length !== 2 || typeof params[0] !== "object" || typeof params[1] !== "object" && typeof params[1] !== "string")
    throw new import_sdk_errors27.JSONRPCInvalidParams(
      "eth_call",
      -32602,
  ...
  try {
    ...
    throw new import_sdk_errors27.JSONRPCInternalError(
      "eth_call()",
      -32603,
...
var ethSendRawTransaction = async (thorClient, params) => {
  ...
  try {
    ...
    throw new import_sdk_errors28.JSONRPCInternalError(
      "eth_sendRawTransaction()",
      -32603,
...
var ethGetLogs = async (thorClient, params) => {
  if (params.length !== 1 || typeof params[0] !== "object")
    throw new import_sdk_errors29.JSONRPCInvalidParams(
      "eth_getLogs",
      -32602,
  ...
  try {
    ...
    throw new import_sdk_errors29.JSONRPCInternalError(
      "ethGetLogs()",
      -32603,
...
var ethRequestAccounts = async (provider) => {
  ...
  if (accounts.length === 0)
    throw new import_sdk_errors30.JSONRPCInvalidParams(
      "eth_getTransactionReceipt()",
      -32602,
      'Method "ethRequestAccounts" failed.',
      {
        provider: (0, import_sdk_errors30.stringifyData)(provider)
      }
    );
  return accounts;
};
...
var RPCMethodsMap = (thorClient, provider) => {
  return {
    ...
    ["eth_coinbase" /* eth_coinbase */]: async () => {
      return await ethCoinbase();
    },
    ["eth_feeHistory" /* eth_feeHistory */]: async () => {
    ...
    ["eth_getUncleByBlockHashAndIndex" /* eth_getUncleByBlockHashAndIndex */]: async () => {
      return await ethGetUncleByBlockHashAndIndex();
    },
    ["eth_getUncleByBlockNumberAndIndex" /* eth_getUncleByBlockNumberAndIndex */]: async () => {
      return await ethGetUncleByBlockNumberAndIndex();
    },
    ["eth_getUncleCountByBlockHash" /* eth_getUncleCountByBlockHash */]: async () => {
      return await ethGetUncleCountByBlockHash();
    },
    ["eth_getUncleCountByBlockNumber" /* eth_getUncleCountByBlockNumber */]: async () => {
      return await ethGetUncleCountByBlockNumber();
    },
    ["eth_getWork" /* eth_getWork */]: async () => {
      return await ethGetWork();
    },
    ["eth_mining" /* eth_mining */]: async () => {
      return await ethMining();
    },
    ["eth_hashrate" /* eth_hashrate */]: async () => {
      return await ethHashrate();
    },
    ["eth_protocolVersion" /* eth_protocolVersion */]: async () => {
      return await ethProtocolVersion();
    },
    ["eth_requestAccounts" /* eth_requestAccounts */]: async () => {
      return await ethRequestAccounts(provider);
    },
    ["eth_sign" /* eth_sign */]: async () => {
      return await ethSign();
    },
    ["eth_submitWork" /* eth_submitWork */]: async () => {
      return await ethSubmitWork();
    },
    ["net_listening" /* net_listening */]: async () => {
      return await netListening(thorClient);
    },
    ["net_peerCount" /* net_peerCount */]: async () => {
      return await netPeerCount(thorClient);
    },
    ["parity_nextNonce" /* parity_nextNonce */]: async () => {
      return await parityNextNonce();
    },
    ["eth_newFilter" /* eth_newFilter */]: async () => {
      return await ethNewFilter();
    },
    ["eth_newBlockFilter" /* eth_newBlockFilter */]: async () => {
      return await ethNewBlockFilter();
    },
    ["eth_newPendingTransactionFilter" /* eth_newPendingTransactionFilter */]: async () => {
      return await ethNewPendingTransactionFilter();
    },
    ["eth_getFilterLogs" /* eth_getFilterLogs */]: async () => {
      return await ethGetFilterLogs();
    },
    ["eth_getFilterChanges" /* eth_getFilterChanges */]: async () => {
      return await ethGetFilterChanges();
    },
    ["eth_uninstallFilter" /* eth_uninstallFilter */]: async () => {
      return await ethUninstallFilter();
    },
    ["debug_getBadBlocks" /* debug_getBadBlocks */]: async () => {
      return await debugGetBadBlocks();
    },
    ["debug_getRawBlock" /* debug_getRawBlock */]: async () => {
      return await debugGetRawBlock();
    },
    ["debug_getRawHeader" /* debug_getRawHeader */]: async () => {
      return await debugGetRawHeader();
    },
    ["debug_getRawReceipts" /* debug_getRawReceipts */]: async () => {
      return await debugGetRawReceipts();
    },
    ["debug_getRawTransaction" /* debug_getRawTransaction */]: async () => {
      return await debugGetRawTransaction();
    },
    ["engine_exchangeCapabilities" /* engine_exchangeCapabilities */]: async () => {
      return await engineExchangeCapabilities();
    },
    ["engine_exchangeTransitionConfigurationV1" /* engine_exchangeTransitionConfigurationV1 */]: async () => {
      return await engineExchangeTransitionConfigurationV1();
    },
    ["engine_forkchoiceUpdatedV1" /* engine_forkchoiceUpdatedV1 */]: async () => {
      return await engineForkchoiceUpdatedV1();
    },
    ["engine_forkchoiceUpdatedV2" /* engine_forkchoiceUpdatedV2 */]: async () => {
      return await engineForkchoiceUpdatedV2();
    },
    ["engine_forkchoiceUpdatedV3" /* engine_forkchoiceUpdatedV3 */]: async () => {
      return await engineForkchoiceUpdatedV3();
    },
    ["engine_getPayloadBodiesByHashV1" /* engine_getPayloadBodiesByHashV1 */]: async () => {
      return await engineGetPayloadBodiesByHashV1();
    },
    ["engine_getPayloadBodiesByRangeV1" /* engine_getPayloadBodiesByRangeV1 */]: async () => {
      return await engineGetPayloadBodiesByRangeV1();
    },
    ["engine_getPayloadV1" /* engine_getPayloadV1 */]: async () => {
      return await engineGetPayloadV1();
    },
    ["engine_getPayloadV2" /* engine_getPayloadV2 */]: async () => {
      return await engineGetPayloadV2();
    },
    ["engine_getPayloadV3" /* engine_getPayloadV3 */]: async () => {
      return await engineGetPayloadV3();
    },
    ["engine_newPayloadV1" /* engine_newPayloadV1 */]: async () => {
      return await engineNewPayloadV1();
    },
    ["engine_newPayloadV2" /* engine_newPayloadV2 */]: async () => {
      return await engineNewPayloadV2();
    },
    ["engine_newPayloadV3" /* engine_newPayloadV3 */]: async () => {
      return await engineNewPayloadV3();
    },
    ["eth_createAccessList" /* eth_createAccessList */]: async () => {
    ...
    ["eth_getProof" /* eth_getProof */]: async () => {
      return await ethGetProof();
    },
    ["eth_maxPriorityFeePerGas" /* eth_maxPriorityFeePerGas */]: async () => {
      return await ethMaxPriorityFeePerGas();
    },
    ["eth_signTransaction" /* eth_signTransaction */]: async () => {
      return await ethSignTransaction();
    },
    ["web3_sha3" /* web3_sha3 */]: async (params) => {
...
var ethGetBlockByNumber = async (thorClient, params) => {
  if (params.length !== 2 || typeof params[0] !== "string" || typeof params[1] !== "boolean")
    throw new import_sdk_errors31.JSONRPCInvalidParams(
  ...
  try {
    ...
    throw new import_sdk_errors31.JSONRPCInternalError(
      "eth_getBlockByNumber()",
      -32603,
...
var ethGetBlockByHash = async (thorClient, params) => {
  if (params.length !== 2 || typeof params[0] !== "string" || !import_sdk_core30.ThorId.isValid(params[0]) || typeof params[1] !== "boolean")
    throw new import_sdk_errors32.JSONRPCInvalidParams(
      "eth_getBlockByHash",
      -32602,
  ...
  try {
    ...
    throw new import_sdk_errors32.JSONRPCInternalError(
      "eth_getBlockByHash()",
      -32603,
      'Method "eth_getBlockByHash" failed.',
      {
        params: (0, import_sdk_errors32.stringifyData)(params),
        url: thorClient.httpClient.baseURL,
        innerError: (0, import_sdk_errors32.stringifyData)(e)
      }
    );
  }
};
...
var ethGetTransactionByHash = async (thorClient, params) => {
  if (params.length !== 1 || typeof params[0] !== "string")
    throw new import_sdk_errors33.JSONRPCInvalidParams(
  ...
  try {
    ...
    throw new import_sdk_errors33.JSONRPCInternalError(
      "eth_getTransactionByHash()",
      -32603,
...
var ethGetTransactionCount = async (params) => {
  ...
  return import_sdk_core31.Hex.of(import_sdk_core31.Secp256k1.randomBytes(6)).toString();
};
...
var ethGetTransactionReceipt = async (thorClient, params) => {
  ...
  try {
    ...
    throw new import_sdk_errors35.JSONRPCInternalError(
      "eth_getTransactionReceipt()",
      -32603,
...
var ethSendTransaction = async (thorClient, params, provider) => {
  if (params.length !== 1 || typeof params[0] !== "object")
    throw new import_sdk_errors36.JSONRPCInvalidParams(
      "eth_sendTransaction",
      -32602,
  ...
  try {
    ...
    throw new import_sdk_errors36.JSONRPCInternalError(
      "eth_sendTransaction()",
      -32603,
      'Method "eth_sendTransaction" failed.',
      {
        params: (0, import_sdk_errors36.stringifyData)(params),
        url: thorClient.httpClient.baseURL
      },
      error
    );
...
var ethSyncing = async (thorClient) => {
  try {
    ...
    const genesisBlock = await thorClient.blocks.getGenesisBlock();
    const highestBlockNumber = genesisBlock !== null ? import_sdk_core33.HexInt.of(
    ...
    throw new import_sdk_errors37.JSONRPCInternalError(
      "eth_syncing()",
      -32603,
...
// src/provider/utils/rpc-mapper/methods-map/methods/web3_sha3/web3_sha3.ts
var import_sdk_errors38 = require("@vechain/sdk-errors");
var import_sdk_core34 = require("@vechain/sdk-core");
var web3Sha3 = async (params) => {
  if (params.length !== 1 || typeof params[0] !== "string" || !import_sdk_core34.Hex.isValid(params[0]))
    throw new import_sdk_errors38.JSONRPCInvalidParams(
      "web3_sha3",
      -32602,
      `Invalid input params for "web3_sha3" method. See 'https://docs.alchemy.com/reference/web3-sha3' for details.`,
      { params }
    );
  return await Promise.resolve(import_sdk_core34.Keccak256.of(params[0]).toString());
};
...
var ethSubscribe = async (thorClient, params, provider) => {
  if (provider === void 0) {
    throw new import_sdk_errors39.JSONRPCInternalError(
      "ethSubscribe()",
      -32603,
      'Method "ethSubscribe" failed. Provider is not defined.',
      {
        url: thorClient.httpClient.baseURL,
        params: (0, import_sdk_errors39.stringifyData)(params)
      }
    );
  }
  if (params[0] !== "newHeads" /* NEW_HEADS */ && params[0] !== "logs" /* LOGS */) {
    throw new import_sdk_errors39.JSONRPCInvalidParams(
      "ethSubscribe()",
      -32602,
  ...
  if (provider.getPollInstance() === void 0) {
    ...
    if (block !== void 0 && block !== null) {
      ...
      throw new import_sdk_errors39.JSONRPCServerError(
        "ethSubscribe()",
        -32e3,
  ...
  const subscriptionId = import_sdk_core35.Hex.random(16).digits;
...
var ethUnsubscribe = async (params, provider) => {
  let result = false;
  if (provider === void 0) {
    throw new import_sdk_errors40.JSONRPCInternalError(
      "ethSubscribe()",
      -32603,
      'Method "ethSubscribe" failed. Provider is not defined.',
      {
...
var debugTraceTransaction = async (thorClient, params) => {
  if (params.length !== 2 || typeof params[0] !== "string" || typeof params[1] !== "object")
    throw new import_sdk_errors41.JSONRPCInvalidParams(
  ...
  if (!import_sdk_core36.ThorId.isValid(transactionId)) {
    throw new import_sdk_errors41.InvalidDataType(
      "debug_traceTransaction()",
      "Invalid transaction ID given as input. Input must be an hex string of length 64.",
      { transactionId }
    );
  ...
  try {
    ...
    throw new import_sdk_errors41.JSONRPCInternalError(
      "debug_traceTransaction()",
      -32603,
      'Method "debug_traceTransaction" failed.',
      {
        ...
        url: thorClient.httpClient.baseURL,
        innerError: (0, import_sdk_errors41.stringifyData)(e)
      }
    );
  }
};
...
var debugTraceCall = async (thorClient, params) => {
  if (params.length !== 3 || typeof params[0] !== "object" || typeof params[1] !== "string" || typeof params[2] !== "object")
    throw new import_sdk_errors42.JSONRPCInvalidParams(
      "debug_traceCall",
      -32602,
  ...
  try {
    ...
    throw new import_sdk_errors42.JSONRPCInternalError(
      "debug_traceCall()",
      -32603,
...
var evmMine = async (thorClient) => {
  try {
    ...
    throw new import_sdk_errors43.JSONRPCInternalError(
      "evm_mine()",
      -32603,
...
var ethCoinbase = async () => {
  (0, import_sdk_logging.VeChainSDKLogger)("warning").log({
    title: "eth_coinbase",
    messages: ['Method "eth_coinbase" has not been implemented yet.']
  });
...
var import_sdk_logging2 = require("@vechain/sdk-logging");
var ethFeeHistory = async () => {
  (0, import_sdk_logging2.VeChainSDKLogger)("warning").log({
...
var ethGetBlockTransactionCountByHash = async (thorClient, params) => {
  if (params.length !== 1 || typeof params[0] !== "string" || !import_sdk_core37.ThorId.isValid(params[0]))
    throw new import_sdk_errors44.JSONRPCInvalidParams(
...
var ethGetBlockTransactionCountByNumber = async (thorClient, params) => {
  if (params.length !== 1 || typeof params[0] !== "string")
    throw new import_sdk_errors45.JSONRPCInvalidParams(
...
var ethGetTransactionByBlockHashAndIndex = async (thorClient, params) => {
  if (params.length !== 2 || typeof params[0] !== "string" || typeof params[1] !== "string")
    throw new import_sdk_errors46.JSONRPCInvalidParams(
  ...
  try {
    ...
    const block = await RPCMethodsMap(thorClient)["eth_getBlockByHash" /* eth_getBlockByHash */]([blockHash, false]);
    for (let i = 0; i < block.transactions.length; i++) {
      const transaction = await RPCMethodsMap(thorClient)["eth_getTransactionByHash" /* eth_getTransactionByHash */]([block.transactions[i]]);
    ...
    throw new import_sdk_errors46.JSONRPCInternalError(
      "eth_getTransactionByBlockHashAndIndex()",
      -32603,
      'Method "eth_getTransactionByBlockHashAndIndex" failed.',
      {
        params: (0, import_sdk_errors46.stringifyData)(params),
        url: thorClient.httpClient.baseURL,
        innerError: (0, import_sdk_errors46.stringifyData)(e)
      }
    );
  }
};
...
var ethGetTransactionByBlockNumberAndIndex = async (thorClient, params) => {
  if (params.length !== 2 || typeof params[0] !== "string" || typeof params[1] !== "string")
    throw new import_sdk_errors47.JSONRPCInvalidParams(
      "eth_getTransactionByBlockHashAndIndex",
      -32602,
      `Invalid input params for "eth_getTransactionByBlockHashAndIndex" method. See ${RPC_DOCUMENTATION_URL} for details.`,
      { params }
  ...
  try {
    const [blockHash, index] = params;
    const block = await RPCMethodsMap(thorClient)["eth_getBlockByNumber" /* eth_getBlockByNumber */]([blockHash, false]);
    for (let i = 0; i < block.transactions.length; i++) {
      const transaction = await RPCMethodsMap(thorClient)["eth_getTransactionByHash" /* eth_getTransactionByHash */]([block.transactions[i]]);
      if (transaction.transactionIndex === index) {
        return transaction;
    ...
    throw new import_sdk_errors47.JSONRPCInternalError(
      "eth_getTransactionByBlockNumberAndIndex()",
      -32603,
      'Method "eth_getTransactionByBlockNumberAndIndex" failed.',
      {
        params: (0, import_sdk_errors47.stringifyData)(params),
        url: thorClient.httpClient.baseURL,
        innerError: (0, import_sdk_errors47.stringifyData)(e)
      }
    );
  }
};
...
var import_sdk_logging3 = require("@vechain/sdk-logging");
var ethGetUncleByBlockHashAndIndex = async () => {
  (0, import_sdk_logging3.VeChainSDKLogger)("warning").log({
...
var import_sdk_logging4 = require("@vechain/sdk-logging");
var ethGetUncleByBlockNumberAndIndex = async () => {
  (0, import_sdk_logging4.VeChainSDKLogger)("warning").log({
...
var import_sdk_logging5 = require("@vechain/sdk-logging");
var ethGetUncleCountByBlockHash = async () => {
  (0, import_sdk_logging5.VeChainSDKLogger)("warning").log({
...
var import_sdk_logging6 = require("@vechain/sdk-logging");
var ethGetUncleCountByBlockNumber = async () => {
  (0, import_sdk_logging6.VeChainSDKLogger)("warning").log({
...
var import_sdk_logging7 = require("@vechain/sdk-logging");
var ethGetWork = async () => {
  (0, import_sdk_logging7.VeChainSDKLogger)("warning").log({
    title: "eth_getWork",
...
var import_sdk_logging8 = require("@vechain/sdk-logging");
var ethMining = async () => {
  (0, import_sdk_logging8.VeChainSDKLogger)("warning").log({
    title: "eth_mining",
...
var import_sdk_logging9 = require("@vechain/sdk-logging");
var ethHashrate = async () => {
  (0, import_sdk_logging9.VeChainSDKLogger)("warning").log({
    title: "eth_hashrate",
    messages: ['Method "eth_hashrate" has not been implemented yet.']
  });
  return await Promise.resolve("METHOD NOT IMPLEMENTED");
};

// src/provider/utils/rpc-mapper/methods-map/methods/eth_protocolVersion/eth_protocolVersion.ts
var import_sdk_logging10 = require("@vechain/sdk-logging");
var ethProtocolVersion = async () => {
  (0, import_sdk_logging10.VeChainSDKLogger)("warning").log({
...
var import_sdk_logging11 = require("@vechain/sdk-logging");
var ethSign = async () => {
  (0, import_sdk_logging11.VeChainSDKLogger)("warning").log({
    title: "eth_sign",
...
var import_sdk_logging12 = require("@vechain/sdk-logging");
var ethSubmitWork = async () => {
  (0, import_sdk_logging12.VeChainSDKLogger)("warning").log({
...
var netListening = async (thorClient) => {
  try {
    return await thorClient.nodes.isHealthy();
  } catch (e) {
    throw new import_sdk_errors48.JSONRPCInternalError(
      "net_listening",
      -32603,
      'Method "net_listening" failed.',
      {
        url: thorClient.httpClient.baseURL,
        innerError: (0, import_sdk_errors48.stringifyData)(e)
      }
    );
  }
};
...
var netPeerCount = async (thorClient) => {
  try {
    const peers = await thorClient.nodes.getNodes();
    return peers !== null ? peers.length : 0;
  } catch (e) {
    throw new import_sdk_errors49.JSONRPCInternalError(
      "net_peerCount",
      -32603,
      'Method "net_peerCount" failed.',
      {
        url: thorClient.httpClient.baseURL,
        innerError: (0, import_sdk_errors49.stringifyData)(e)
      }
    );
  }
};
...
var import_sdk_logging13 = require("@vechain/sdk-logging");
var parityNextNonce = async () => {
  (0, import_sdk_logging13.VeChainSDKLogger)("warning").log({
...
var import_sdk_logging14 = require("@vechain/sdk-logging");
var ethNewFilter = async () => {
  (0, import_sdk_logging14.VeChainSDKLogger)("warning").log({
    title: "eth_newFilter",
    messages: ['Method "eth_newFilter" has not been implemented yet.']
  });
  return await Promise.resolve("METHOD NOT IMPLEMENTED");
};

// src/provider/utils/rpc-mapper/methods-map/methods/eth_newBlockFilter/eth_newBlockFilter.ts
var import_sdk_logging15 = require("@vechain/sdk-logging");
var ethNewBlockFilter = async () => {
  (0, import_sdk_logging15.VeChainSDKLogger)("warning").log({
...
var import_sdk_logging16 = require("@vechain/sdk-logging");
var ethNewPendingTransactionFilter = async () => {
  (0, import_sdk_logging16.VeChainSDKLogger)("warning").log({
...
var import_sdk_logging17 = require("@vechain/sdk-logging");
var ethGetFilterLogs = async () => {
  (0, import_sdk_logging17.VeChainSDKLogger)("warning").log({
...
var import_sdk_logging18 = require("@vechain/sdk-logging");
var ethGetFilterChanges = async () => {
  (0, import_sdk_logging18.VeChainSDKLogger)("warning").log({
...
var import_sdk_logging19 = require("@vechain/sdk-logging");
var ethUninstallFilter = async () => {
  (0, import_sdk_logging19.VeChainSDKLogger)("warning").log({
...
var import_sdk_logging20 = require("@vechain/sdk-logging");
var debugGetBadBlocks = async () => {
  (0, import_sdk_logging20.VeChainSDKLogger)("warning").log({
...
var import_sdk_logging21 = require("@vechain/sdk-logging");
var debugGetRawBlock = async () => {
  (0, import_sdk_logging21.VeChainSDKLogger)("warning").log({
...
var import_sdk_logging22 = require("@vechain/sdk-logging");
var debugGetRawHeader = async () => {
  (0, import_sdk_logging22.VeChainSDKLogger)("warning").log({
...
var import_sdk_logging23 = require("@vechain/sdk-logging");
var debugGetRawReceipts = async () => {
  (0, import_sdk_logging23.VeChainSDKLogger)("warning").log({
...
var import_sdk_logging24 = require("@vechain/sdk-logging");
var debugGetRawTransaction = async () => {
  (0, import_sdk_logging24.VeChainSDKLogger)("warning").log({
...
var import_sdk_logging25 = require("@vechain/sdk-logging");
var engineExchangeCapabilities = async () => {
  (0, import_sdk_logging25.VeChainSDKLogger)("warning").log({
...
var import_sdk_logging26 = require("@vechain/sdk-logging");
var engineExchangeTransitionConfigurationV1 = async () => {
  (0, import_sdk_logging26.VeChainSDKLogger)("warning").log({
...
var import_sdk_logging27 = require("@vechain/sdk-logging");
var engineForkchoiceUpdatedV1 = async () => {
  (0, import_sdk_logging27.VeChainSDKLogger)("warning").log({
...
var import_sdk_logging28 = require("@vechain/sdk-logging");
var engineForkchoiceUpdatedV2 = async () => {
  (0, import_sdk_logging28.VeChainSDKLogger)("warning").log({
...
var import_sdk_logging29 = require("@vechain/sdk-logging");
var engineForkchoiceUpdatedV3 = async () => {
  (0, import_sdk_logging29.VeChainSDKLogger)("warning").log({
...
var import_sdk_logging30 = require("@vechain/sdk-logging");
var engineGetPayloadBodiesByHashV1 = async () => {
  (0, import_sdk_logging30.VeChainSDKLogger)("warning").log({
...
var import_sdk_logging31 = require("@vechain/sdk-logging");
var engineGetPayloadBodiesByRangeV1 = async () => {
  (0, import_sdk_logging31.VeChainSDKLogger)("warning").log({
...
var import_sdk_logging32 = require("@vechain/sdk-logging");
var engineGetPayloadV1 = async () => {
  (0, import_sdk_logging32.VeChainSDKLogger)("warning").log({
...
var import_sdk_logging33 = require("@vechain/sdk-logging");
var engineGetPayloadV2 = async () => {
  (0, import_sdk_logging33.VeChainSDKLogger)("warning").log({
...
var import_sdk_logging34 = require("@vechain/sdk-logging");
var engineGetPayloadV3 = async () => {
  (0, import_sdk_logging34.VeChainSDKLogger)("warning").log({
...
var import_sdk_logging35 = require("@vechain/sdk-logging");
var engineNewPayloadV1 = async () => {
  (0, import_sdk_logging35.VeChainSDKLogger)("warning").log({
...
var import_sdk_logging36 = require("@vechain/sdk-logging");
var engineNewPayloadV2 = async () => {
  (0, import_sdk_logging36.VeChainSDKLogger)("warning").log({
...
var import_sdk_logging37 = require("@vechain/sdk-logging");
var engineNewPayloadV3 = async () => {
  (0, import_sdk_logging37.VeChainSDKLogger)("warning").log({
    title: "engine_newPayloadV3",
    messages: ['Method "engine_newPayloadV3" has not been implemented yet.']
  });
  return await Promise.resolve("METHOD NOT IMPLEMENTED");
};

// src/provider/utils/rpc-mapper/methods-map/methods/eth_createAccessList/eth_createAccessList.ts
var import_sdk_logging38 = require("@vechain/sdk-logging");
var ethCreateAccessList = async () => {
  (0, import_sdk_logging38.VeChainSDKLogger)("warning").log({
...
var ethGetBlockReceipts = async (thorClient, params) => {
  if (params.length !== 1 || typeof params[0] !== "string")
    throw new import_sdk_errors50.JSONRPCInvalidParams(
  ...
  try {
    ...
    throw new import_sdk_errors50.JSONRPCInternalError(
      "ethGetBlockReceipts()",
      -32603,
      'Method "ethGetBlockReceipts" failed.',
      {
        params: (0, import_sdk_errors50.stringifyData)(params),
        url: thorClient.httpClient.baseURL,
        innerError: (0, import_sdk_errors50.stringifyData)(e)
      }
    );
  }
};
...
var import_sdk_logging39 = require("@vechain/sdk-logging");
var ethGetProof = async () => {
  (0, import_sdk_logging39.VeChainSDKLogger)("warning").log({
    title: "eth_getProof",
...
var import_sdk_logging40 = require("@vechain/sdk-logging");
var ethMaxPriorityFeePerGas = async () => {
  (0, import_sdk_logging40.VeChainSDKLogger)("warning").log({
...
var import_sdk_logging41 = require("@vechain/sdk-logging");
var ethSignTransaction = async () => {
  (0, import_sdk_logging41.VeChainSDKLogger)("warning").log({
    title: "eth_signTransaction",
    messages: ['Method "eth_signTransaction" has not been implemented yet.']
  });
  return await Promise.resolve("METHOD NOT IMPLEMENTED");
};

// src/provider/providers/vechain-provider/vechain-provider.ts
var import_sdk_core38 = require("@vechain/sdk-core");
var VeChainProvider = class extends import_events2.EventEmitter {
  /**
  ...
  constructor(thorClient, wallet, enableDelegation = false) {
    ...
    if (enableDelegation && wallet?.delegator === void 0) {
      throw new import_sdk_errors51.JSONRPCInvalidParams(
  ...
  async request(args) {
    if (!Object.values(RPC_METHODS).map((key) => key.toString()).includes(args.method)) {
      throw new import_sdk_errors51.JSONRPCMethodNotFound(
  ...
  async getLogsRPC() {
    const promises = Array.from(
      ...
      const currentBlock = import_sdk_core38.HexInt.of(
        this.subscriptionManager.currentBlockNumber
      ).toString();
      const filterOptions = {
...
var import_sdk_logging42 = require("@vechain/sdk-logging");
  ...
  async request(args) {
    try {
      if (this.debug) {
        ...
        (0, import_sdk_logging42.VeChainSDKLogger)("log").log({
          title: `Sending request - ${args.method}`,
          messages: [
            `params: ${(0, import_sdk_errors52.stringifyData)(args.params)}`,
            `accounts: ${(0, import_sdk_errors52.stringifyData)(accounts)}`,
            `delegator: ${(0, import_sdk_errors52.stringifyData)(delegator)}`,
      ...
      if (this.debug) {
        (0, import_sdk_logging42.VeChainSDKLogger)("log").log({
          ...
          messages: [`result: ${(0, import_sdk_errors52.stringifyData)(result)}`]
        });
      }
      return result;
    } catch (error) {
      if (this.debug) {
        (0, import_sdk_logging42.VeChainSDKLogger)("error").log(
          new import_sdk_errors52.JSONRPCInternalError(
            args.method,
            -32603,
      ...
      if (error instanceof import_sdk_errors52.VechainSDKError) {
