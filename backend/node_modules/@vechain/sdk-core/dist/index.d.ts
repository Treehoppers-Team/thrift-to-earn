 ...
 *
 */
declare function sign$1(cert: Certificate, privateKey: Uint8Array): Certificate;
/**
 ...
 */
declare function sign(transactionBody: TransactionBody, signerPrivateKey: Buffer): Transaction;
/**
...
declare class Secp256k1 {
     ...
     */
    private static readonly SIGNATURE_LENGTH;
    /**
     ...
     */
    static randomBytes(bytesLength?: number | undefined): Uint8Array;
    /**
...
declare class FPN implements VeChainDataModel<FPN> {
    /**
     ...
     */
    static readonly NEGATIVE_INFINITY: FPN;
    /**
     ...
     */
    static readonly POSITIVE_INFINITY: FPN;
    /**
     ...
     */
    dp(decimalPlaces: bigint | number): FPN;
    /**
     ...
     * false otherwise.
     */
    static isUnsignedIntegerExpression(exp: string): boolean;
    /**
     ...
     */
    private static mul;
    static of(exp: bigint | number | string, decimalPlaces?: bigint): FPN;
    /**
...
type core_FPN = FPN;
declare const core_FPN: typeof FPN;
